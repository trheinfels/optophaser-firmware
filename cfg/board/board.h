...
/*
    Changes to original file (external/chibios/os/hal/boards/ST_STM32L_DISCOVERY/board.h):
      - Adapt to optophaser board
      - Remove note about automatic generation
*/
...
/*
 * Setup for OptoPhaser board.
 */

/*
 * Board identifier.
 */
#define BOARD_OPTOPHASER
#define BOARD_NAME                  "OptoPhaser"
 ...
 */
#define LINE_DAC                    PAL_LINE(GPIOA, GPIOA_PIN4)
#define LINE_CV                     PAL_LINE(GPIOA, GPIOA_PIN5)
#define LINE_FRQ                    PAL_LINE(GPIOA, GPIOA_PIN6)
#define LINE_WVF                    PAL_LINE(GPIOA, GPIOA_PIN7)
...
#define LINE_BOOT1                  PAL_LINE(GPIOB, GPIOB_PIN2)
#define LINE_PWM                    PAL_LINE(GPIOB, GPIOB_PIN3)
#define LINE_ENC_A                  PAL_LINE(GPIOB, GPIOB_PIN4)
#define LINE_ENC_B                  PAL_LINE(GPIOB, GPIOB_PIN5)
#define LINE_ENC_S                  PAL_LINE(GPIOB, GPIOB_PIN6)
#define LINE_TAP                    PAL_LINE(GPIOB, GPIOB_PIN7)
 ...
 * PB1  - PIN1                      (analog).
 * PB2  - BOOT1                     (analog).
 * PB3  - PWM (disabled)            (analog).
 * PB4  - ENC_A                     (alternate 2, pullup).
 * PB5  - ENC_B                     (alternate 2, pullup).
 * PB6  - ENC_S                     (input, pullup).
 * PB7  - TAP                       (input, pullup).
 * PB8  - PIN8                      (analog).
 * PB9  - PIN9                      (analog).
 * PB10 - PIN10                     (analog).
 * PB11 - PIN11                     (analog).
